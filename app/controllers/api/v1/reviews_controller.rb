class Api::V1::ReviewsController < ApplicationController
  ...
  def index
    ...
    json_response "Index reviews successfully", true,{reviews: review_serializer}, :ok
  end
  ...
  def create
    ...
    if review.save
      review_serializer = parse_json review
      json_response "Created review success", true, {review: review_serializer}, :ok
    else
  ...
  def load_book
    ...
    unless @book.present?
      json_response "Can't find a book", false, {}, :not_found
    end
  end
